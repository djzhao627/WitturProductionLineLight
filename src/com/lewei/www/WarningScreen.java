				...
				case 9:
					...
					case 1:
						if (btn[2] == 1) {
							...
							if (red1) {
								dealWittturBtnWarningToLewei("AA;1");
							}
							red1 = false;
						}
						break;
					...
					case 4:
						if (btn[2] == 1) {
							...
							if (red2) {
								dealWittturBtnWarningToLewei("AA;2");
							}
							red2 = false;
						}
						break;
				...
				case 10:
					...
					case 1:
						if (btn[2] == 1) {
							...
							if (red3) {
								dealWittturBtnWarningToLewei("AA;3");
							}
							red3 = false;
						}
						break;
					...
					case 4:
						if (btn[2] == 1) {
							...
							if (red4) {
								dealWittturBtnWarningToLewei("AA;4");
							}
							red4 = false;
						}
						break;
				...
				case 11:
					...
					case 1:
						if (btn[2] == 1) {
							...
							if (red5) {
								dealWittturBtnWarningToLewei("AA;5");
							}
							red5 = false;
						}
						break;
					...
					case 4:
						if (btn[2] == 1) {
							...
							if (red6) {
								dealWittturBtnWarningToLewei("AA;6");
							}
							red6 = false;
						}
						break;
				...
				case 12:
					...
					case 1:
						if (btn[2] == 1) {
							...
							if (red7) {
								dealWittturBtnWarningToLewei("AA;7");
							}
							red7 = false;
						}
						break;
					...
					case 4:
						if (btn[2] == 1) {
							...
							if (red8) {
								dealWittturBtnWarningToLewei("AA;8");
							}
							isLost = true;
						} else {
							if (!yellow8 && !green8) {
