...
//	}
	...
	public static void main(String[] args) {
		// 这个类主要是设置邮件
		MailSenderInfo mailInfo = new MailSenderInfo();
		mailInfo.setMailServerHost("CN-MAIL2.cn.wittur.org");
		mailInfo.setMailServerPort("25");
		mailInfo.setValidate(true);
		mailInfo.setUserName("production@wittur.com");
		mailInfo.setPassword("Aa123456");// 您的邮箱密码
//		mailInfo.setFromAddress("YaRu.Cheng@wittur.com");
		mailInfo.setFromAddress("production@wittur.com");
		// mailInfo.setToAddress("89402393@qq.com");
		mailInfo.setToAddress("894559192@qq.com");
		mailInfo.setSubject("来自djzhao");
		mailInfo.setContent("This is a test email for java mail~ !");
